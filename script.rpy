...
label choices4_common:
    ...
    m "Коли я почув останній крик Боба, час перестав йти для мене."
    m "Я боявся видавати звуки, навіть дихання. Мені було дуже страшно."
    m "В мить я подумав, що вже розстався зі своїм життям, як і Боб. Я ніби-то випав з реальності."
    m "Я вже почав уявляти, що відбулось з Бобом, але з цього стану мене витянула Неллі, котра товкала мене в плече."
    m "Ще деякий час я просто дивився на неї. На її лиці був страх і нерозуміння."
    m "Коли я зрозумів, що щось потрібно робити, я ввімкнув свій ліхтарик, взяв Неллі за руку і потягнув в попередню локацію."
    m "В мить вона зупинилась і почала дивитись на землю перед входом в кімнату."
    m "Я подивився туди ж та побачив розбризкану чорну рідину..."
